...
//                alert(style);
            ...
            function resetUpdateForm() {
                ...
                $.ajax({
                    ...
                    data: {upgroupName: upgroupName, RequstToken: token},
                    dataType: "json",
                    type: "POST",
                    success: function (data) {
                        $stoken=data.token;
            ...
            $(document).ready(function () {
                ...
                $("#listOpr").on('change', function () {
                    if ($(this).val() > 0) {
                        ...
                        $.ajax({
                            url: '${pageContext.request.contextPath}/getMessageoprMng',
                            data: {listOpr: $(this).val(), RequstToken: token},
                            dataType: "json",
                            type: "POST",
                            success: function (data) {
                                $stoken=data.token;
    ...
    <s:set id="download" var="download"><s:property  value="update" default="true"/></s:set>
        ...
        <body>
            ...
            <div class="content innerpage">
                            ...
                            <div class="d-row cpanel four-col">
                                ...
                                <div class="right-col">                                     
                                    ...
                                    <div class="btn-wrap lnk-match">
                                        ...
                                        <sj:submit disabled="#download"   button="true" id="exportPdfbutton" name="exportPdfbutton"   value="Export PDF"   onclick="downloadOperaiton()" cssClass="btn default-button"/>
                                    </div>
                                     <sj:a 
                                        id="refresh" 
                                        button="true"                                        
                                        ...
                                        role="button" aria-disabled="false"                                    
                                        ><i class="fa fa-times" aria-hidden="true"></i> Reset</sj:a>
                ...
                <div class="content-section data-form" id="addDiv" >
                    ...
                    <s:form id="addnewhost" theme="simple" method="post" action="AddoprMng" name="testform">
                        <div class="content-data">
                            ...
                            <div class="d-row cpanel four-col">
                                ...
                                <div class="right-col">
                                     ...
                                     <div class="btn-wrap"><i class="fa fa-paper-plane" aria-hidden="true"></i><sj:submit id="ssbtn" value="Send" disabled="#send" targets="divmsg" button="true" href="%{addurl}" cssClass="btn default-button"   cssStyle="height:25px"/></div>
                ...
                <div class="content-section">
                    ...
                    <div id="tablediv" class="custom-grid">
                        ...
                        <s:url var="listurl" action="ListoprMngement"/>
                        <sjg:grid
                            id="gridtable"
                            ...
                            <sjg:gridColumn title="Operaiton" name="operaiton" index="operationId"  align="left" width="20" sortable="true"/>  
...
//                alert('clicked');
//                document.getElementById("addnewhost").submit();
//            });
            $(document).ready(function () {
                //Back button event
