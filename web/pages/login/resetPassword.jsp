...
<html>
    ...
    <body>
        ...
        <!-- Login form begin -->
        <div class="login-box">
            <h1 style="border-right: 0px;width: 100%;text-align: center;font-size: 28px;margin-bottom: 10px">Change Password</h1>
          <div class="msg-panel error-login-msg">
                <s:actionerror/>
                <s:actionmessage/>
            </div>
            <div class="login-form" style="margin-bottom: 50px;">
                <s:form id="resetpassfrm" action="resetPassword" namespace="/" theme="simple">
                    ...
                    <s:password  placeholder="Confirm password" id="repeatPassword" name="repeatPassword" cssClass="txt-input width-35"/>
                    <!--<input type="text" name="userName" placeholder="Username" />-->
                    <!--<input type="password" name="password" placeholder="Password" />-->
                    <sj:submit  value="Change"  button="true"  cssClass="btn-login"  style="width: 45%;margin-top: 20px;"/>

                    <!--<input type="submit" class="btn-login" value="Change Password" style="width: 71%;margin-top: 20px;" />-->
